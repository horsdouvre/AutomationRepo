...
public class ViewPortfolioSummary {
	...
	@Test
	public void AccessDocuments_GSSP_3787() throws Exception {
		try
		{	
			...
			{	
				...
				flagStatus(TestBase.verifyCompare(obj.verify_PortfolioSummaryPage, ver.verify_PortfolioSummaryPage));

				testStep.clickLink(obj.policyDetailLink);

				flagStatus(TestBase.verifyCompare(obj.verify_PolicyDetailsPage, ver.verify_PolicyDetailsPage));

				testStep.clickLink(obj.correspondenceLink);

				flagStatus(TestBase.verifyCompare(obj.verify_DocumentsPage, ver.verify_DocumentsPage));
	...
	@Test
	public void AccessForms_GSSP_3793() throws Exception {
		try
		{	
			sTestCaseName = new Exception().getStackTrace()[0].getMethodName();
			Log.startTestCase(sTestCaseName);
			...
			{	
				...
				flagStatus(TestBase.verifyCompare(action.getText(obj.verify_PolicyDetailsPage), ver.verify_PolicyDetailsPage));

				testStep.clickLink(obj.formsLink);

				flagStatus(TestBase.verifyCompare(obj.verify_FormsPage, ver.verify_FormsPage));
	...
	public void AccessDocuments_GSSP_1114_01() throws Exception {
		try
		{	
			sTestCaseName = new Exception().getStackTrace()[0].getMethodName();
